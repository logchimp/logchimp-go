...
func TestUserAgentHeader(t *testing.T) {
	...
	if userAgent != fmt.Sprintf("Logchimp/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Auth.Login(context.Background(), logchimp.AuthLoginParams{
		Email:    "mike@example.com",
		Password: "password",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Auth.Login(cancelCtx, logchimp.AuthLoginParams{
		Email:    "mike@example.com",
		Password: "password",
	})
	if err == nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Auth.Login(deadlineCtx, logchimp.AuthLoginParams{
			Email:    "mike@example.com",
			Password: "password",
		})
		if err == nil {
