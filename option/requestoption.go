...
// RequestOption is an option for the requests made by the logchimp API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/logchimp-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("PROTOCOL://HOST_WITH_PORT/api/v1/")
}
...
// WithProtocol returns a RequestOption that sets the client setting "protocol".
func WithProtocol(value string) RequestOption {
...
// WithHostWithPort returns a RequestOption that sets the client setting "host-with-port".
func WithHostWithPort(value string) RequestOption {
	return requestconfig.PreRequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.HostWithPort = value
		return nil
	})
}
